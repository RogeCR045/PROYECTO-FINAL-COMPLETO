...
<head>
  ...
  <!--Style personalizado-->
  <link rel="stylesheet" href="{{ asset('/dist/css/index.css') }}" type="text/css">
  <!-- Google Font: Source Sans Pro -->
  <link href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,400i,700" rel="stylesheet">
</head>

<body class="hold-transition user-img">
  <div class="login-box">
    ...
    <div class="card">
      <div class="card-body login-card-body">
        ...
        <div class="col-12">
          <center>
            <img src="\images\usuario2.png" width="100" height="100" alt="#">
          </center>
        </div>
        <form method="POST" action="{{ route('login') }}">
          ...
          <div class="row">
            ...
            <!-- /.col -->
            <div class="col-4">
              <button type="submit" class="btn btn-primary btn-back">Iniciar Sesión</button>
              <br>
              <br>
